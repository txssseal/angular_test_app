...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '[A-Za-z0-9._%-]+@gmail.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20150917152222');

INSERT INTO schema_migrations (version) VALUES ('20150917165315');

INSERT INTO schema_migrations (version) VALUES ('20150917170403');

INSERT INTO schema_migrations (version) VALUES ('20150917182431');
